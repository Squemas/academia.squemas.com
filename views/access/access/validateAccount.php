					...
					<div class="m-login__container">
						...
						<div>
							<div class="m-login__head">
								...
								<div class="m-login__desc"><?Php echo $this->vStatusValidateEmailAccount; ?></div>
							</div>
						</div>
						<div class="m-login__account">
							<span class="m-login__account-msg">¿Quiero acceder a la Academia?</span>
							&nbsp;&nbsp;
							<a href="<?Php echo BASE_VIEW_URL; ?>access" id="m_login_signup" class="m-link m-link--light m-login__account-link">Ingresar</a>
						</div>
					</div>
				</div>
			</div>
