				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div>
							...
							<form class="m-login__form m-form" id="access-form-emailvalidate">
						...
						<div class="m-login__account">
							<span class="m-login__account-msg">¿No tienes una cuenta aún?</span>
							&nbsp;&nbsp;
							<a href="<?Php echo BASE_VIEW_URL; ?>access/register" id="m_login_signup" class="m-link m-link--light m-login__account-link">Registrate</a>
						</div>
					</div>
				</div>
			</div>
